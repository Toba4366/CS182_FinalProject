"""
Training utilities for the Moore machine ICL LSTM.
"""
...
from src.models.moore_lstm import MooreLSTM
...
class MooreLSTMTrainer:
    """Thin training loop wrapper for the LSTM."""
