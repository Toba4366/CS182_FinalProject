"""
Entry point for training the Moore Vanilla RNN in an ICL setting.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Vanilla RNN for Moore ICL")
...
def main():
    ...
    # Save checkpoint
    checkpoint_path = log_dir / f"vanilla_rnn_direct_{timestamp}.pt"
    torch.save({
        "epoch": args.epochs,
    ...
    metrics_path = log_dir / f"vanilla_rnn_direct_{timestamp}_metrics.json"
